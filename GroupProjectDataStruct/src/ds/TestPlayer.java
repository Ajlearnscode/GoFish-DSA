...
System.out.println("=== Testing Player Methods ===\n");
    ...
    public static void testRemoveCard() {
        ...
        // Create a player
        Human player = new Human("TestPlayer");
    ...
    // Test 3: Test HumanPlayer.chooseRank() - commented out because it requires user input
    ...
    public static void displayHand(Player player) {
        ...
        while (curr != null) {
            ...
            System.out.println("  " + count + ". " + card.getRank() + " of " + 
                             card.getSuit() + " (" + card.getColour() + ")");
